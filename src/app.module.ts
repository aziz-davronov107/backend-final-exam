...
import { CourseCategoryModule } from './entities/course-category/course-category.module';
...
@Module({
  imports: [CoreModule,UserModule, CourseCategoryModule, CourseModule, LessonModule, HomeworkModule, ExamModule, VerificationModule,AuthModule],
  providers:[
    {
      provide: APP_GUARD,
